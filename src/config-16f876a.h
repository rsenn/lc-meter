...
#ifdef _DEBUG
__CONFIG(FOSC_HS& WDTE_OFF& PWRTE_ON& BOREN_ON& LVP_OFF& CPD_OFF& DEBUG_ON& CP_OFF);
#else
__CONFIG(FOSC_HS& WDTE_OFF& PWRTE_ON& BOREN_ON& LVP_OFF& CPD_OFF& DEBUG_OFF& CP_OFF);
#endif
