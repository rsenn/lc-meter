...
PRODL	equ	0xff3
	...
	idata
_print_unit_units_65536_64	db	LOW(___str_0), HIGH(___str_0), UPPER(___str_0), LOW(___str_1), HIGH(___str_1), UPPER(___str_1), LOW(___str_2), HIGH(___str_2), UPPER(___str_2), LOW(___str_3), HIGH(___str_3), UPPER(___str_3)
...
_output_putch:
;	.line	497; ../../../src/print.c	output_putch(char c) {
	MOVFF	FSR2H, POSTDEC1
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1H, FSR2H
	MOVFF	FSR1L, FSR2L
	...
	MOVLW	0x03
	MOVFF	PLUSW2, r0x00
;	.line	499; ../../../src/print.c	lcd_putch(c);
	MOVLW	0x01
	MOVWF	POSTDEC1
	MOVF	r0x00, W
	MOVWF	POSTDEC1
...
_indicator:
;	.line	473; ../../../src/print.c	indicator(uint8_t indicate) {
	MOVFF	FSR2H, POSTDEC1
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1H, FSR2H
	MOVFF	FSR1L, FSR2L
	...
	MOVLW	0x03
	MOVFF	PLUSW2, r0x00
;	.line	487; ../../../src/print.c	lcd_gotoxy(0, 1);
	MOVLW	0x01
	MOVWF	POSTDEC1
	MOVLW	0x00
	MOVWF	POSTDEC1
	...
	MOVF	POSTINC1, F
	MOVF	POSTINC1, F
;	.line	488; ../../../src/print.c	if(indicate) {
	MOVF	r0x00, W
	BZ	_00140_DS_
...
_print_reading:
;	.line	433; ../../../src/print.c	print_reading(uint16_t measurement) {
	MOVFF	FSR2H, POSTDEC1
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1H, FSR2H
	MOVFF	FSR1L, FSR2L
...
;	.line	461; ../../../src/print.c	lcd_puts("     ");
	...
	BTFSC	STATUS, 0
	INCF	FSR1H, F
;	.line	462; ../../../src/print.c	lcd_gotoxy(9, 0);
	MOVLW	0x00
	MOVWF	POSTDEC1
	MOVLW	0x09
	MOVWF	POSTDEC1
...
;	.line	464; ../../../src/print.c	format_number(/*&buffer_putch,*/ measurement / 100, 10, 0);
	...
	BTFSC	STATUS, 0
	INCF	FSR1H, F
;	.line	466; ../../../src/print.c	format_number(/*&buffer_putch,*/ measurement % 100, 10, 0);
	MOVLW	0x00
	MOVWF	POSTDEC1
	MOVLW	0x64
	MOVWF	POSTDEC1
...
_print_unit:
;	.line	412; ../../../src/print.c	print_unit(uint8_t unit) {
	MOVFF	FSR2H, POSTDEC1
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1H, FSR2H
	MOVFF	FSR1L, FSR2L
	...
	MOVFF	r0x01, POSTDEC1
	MOVFF	r0x02, POSTDEC1
;	.line	421; ../../../src/print.c	lcd_gotoxy(14, 0);
	MOVLW	0x00
	MOVWF	POSTDEC1
	MOVLW	0x0e
	MOVWF	POSTDEC1
	...
	MOVF	POSTINC1, F
	BANKSEL	(_buffer + 16)
;	.line	425; ../../../src/print.c	lcd_gotoxy(16 - BUFFER_LEN(), 0);
	MOVF	(_buffer + 16), W, B
	SWAPF	WREG, W
	ANDLW	0x0f
	MOVWF	r0x00
	...
	MOVF	POSTINC1, F
	MOVF	POSTINC1, F
;	.line	428; ../../../src/print.c	uart_puts("\r\n");
	MOVLW	HIGH(___str_8)
	MOVWF	r0x01
	MOVLW	LOW(___str_8)
	MOVWF	r0x00
...
_print_digit:
;	.line	390; ../../../src/print.c	print_digit(uint8_t line, uint8_t column, uint8_t digit) {
	MOVFF	FSR2H, POSTDEC1
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1H, FSR2H
	MOVFF	FSR1L, FSR2L
	...
	MOVLW	0x05
	MOVFF	PLUSW2, r0x01
;	.line	405; ../../../src/print.c	lcd_gotoxy(column, /*line - 1*/ 0);
	MOVLW	0x00
	MOVWF	POSTDEC1
	MOVF	r0x00, W
	MOVWF	POSTDEC1
	...
	MOVF	POSTINC1, F
	MOVF	POSTINC1, F
;	.line	406; ../../../src/print.c	lcd_putch('0' + digit);
	MOVLW	0x30
	ADDWF	r0x01, F
	MOVLW	0x01
	MOVWF	POSTDEC1
...
;	.line	33; ../../../src/print.c	lcd_put(const char* buf, unsigned n) {
	...
	MOVFF	PLUSW2, r0x04
_00105_DS_:
;	.line	37; ../../../src/print.c	while(n--) lcd_putch(*buf++);
	MOVFF	r0x03, r0x05
	MOVFF	r0x04, r0x06
	MOVLW	0xff
	ADDWF	r0x03, F
...
; Statistics:
; code size:	 1072 (0x0430) bytes ( 0.82%)
;           	  536 (0x0218) words
