	...
	;
	; --chip=18F2455 -G \
	; -mdist/default/production/LC_meter_18f2455_xc8.X.production.map \
	; -DXPRJ_default=default --double=32 --float=24 --emi=wordwrite \
	; --opt=+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro \
	; -D__XC=1 -D__18f2455=1 -DUSE_TIMER1=1 -DUSE_TIMER2=1 -DUSE_SER=1 \
	; -DUSE_HD44780_LCD=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -P -N255 \
	; -I../../../src -I../../../lib -v --warn=-3 --asmlist \
	...
	; -odist/default/production/LC_meter_18f2455_xc8.X.production.cof \
	...
	; build/default/production/_ext/1386528437/LC-meter.p1 --ccmode=cci
	;
