...
psect	strings
STR_1	equ	STR_2+1
	file	"dist/default/production\LC-meter-HD44780.X.production.as"
	line	#
...
;; *************** function _main *****************
;; Defined at:
;;		line 99 in file "../../../src/LC-meter.c"
...
l7464:	
;LC-meter.c: 107: initialize();
	fcall	_initialize
	line	110
	
l7466:	
;LC-meter.c: 110: lcd_set_cursor(0, 0);
...
l7468:	
;LC-meter.c: 112: lcd_print("LC-meter");
...
l7470:	
;LC-meter.c: 126: {
;LC-meter.c: 127: uint16_t prev_seconds = 0xffff;
	movlw	low(0FFFFh)
...
l7472:	
;LC-meter.c: 134: lcd_set_cursor(0, 1);
	clrf	(?_lcd_set_cursor)
...
l7474:	
;LC-meter.c: 135: display_print_number(ccp1t[1] - ccp1t_lr, 16, -4);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l7476:	
;LC-meter.c: 139: if(seconds != prev_seconds)
...
l7478:	
;LC-meter.c: 140: {
;LC-meter.c: 142: format_number(ser_putch, seconds, 10, 0);
	...
	line	144
;LC-meter.c: 144: ser_puts("\r\n");
	movlw	((STR_12-__stringbase))&0ffh
	fcall	_ser_puts
	line	146
	
l7480:	
;LC-meter.c: 146: prev_seconds = seconds;
	bcf	status, 5	;RP0=0, select bank0
	movf	(_seconds+1),w	;volatile
	movwf	(main@prev_seconds+1)
	movf	(_seconds),w	;volatile
...
;; Defined at:
;;		line 167 in file "../../../src/LC-meter.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l7432:	
;LC-meter.c: 169: CM0 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1248/8)^080h,(1248)&7
	line	170
;LC-meter.c: 170: CM1 = 0;
	bcf	(1249/8)^080h,(1249)&7
	line	171
;LC-meter.c: 171: CM2 = 1;
	bsf	(1250/8)^080h,(1250)&7
	line	173
	
l7434:	
;LC-meter.c: 173: TRISA = 0b11001111;
	movlw	(0CFh)
	movwf	(133)^080h	;volatile
	line	175
	
l7436:	
;LC-meter.c: 175: setup_timer0();
	fcall	_setup_timer0
	line	176
	
l7438:	
;LC-meter.c: 176: T0IE = 1;
	bsf	(93/8),(93)&7
	line	177
	
l7440:	
;LC-meter.c: 177: T0IF = 0;
	bcf	(90/8),(90)&7
	line	184
	
l7442:	
;LC-meter.c: 184: SSPEN = 0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(165/8),(165)&7
	line	189
	
l7444:	
;LC-meter.c: 189: TRISC4 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1084/8)^080h,(1084)&7
	line	190
	
l7446:	
;LC-meter.c: 190: nRBPU = 1;
	bsf	(1039/8)^080h,(1039)&7
	line	195
	
l7448:	
;LC-meter.c: 195: TRISA2 = TRISC3 = 0;
	bcf	(1083/8)^080h,(1083)&7
	bcf	(1066/8)^080h,(1066)&7
	line	196
	
l7450:	
;LC-meter.c: 196: RA2 = RC3 = 1;
	bcf	status, 5	;RP0=0, select bank0
	bsf	(59/8),(59)&7
	btfsc	(59/8),(59)&7
	goto	u1281
...
l7452:	
;LC-meter.c: 199: ser_init();
	fcall	_ser_init
	line	202
	
l7454:	
;LC-meter.c: 202: TRISC5 = 0;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1085/8)^080h,(1085)&7
	line	205
	
l7456:	
;LC-meter.c: 205: PEIE = 1;
	bsf	(94/8),(94)&7
	line	206
	
l7458:	
;LC-meter.c: 206: GIE = 1;
	bsf	(95/8),(95)&7
	line	213
	
l7460:	
;LC-meter.c: 213: lcd_init(1);
	movlw	(01h)
	fcall	_lcd_init
	line	214
	
l7462:	
;LC-meter.c: 214: lcd_begin(2, 1);
	bcf	status, 5	;RP0=0, select bank0
	clrf	(?_lcd_begin)
	incf	(?_lcd_begin),f
	movlw	(02h)
...
i1l6962:	
;LC-meter.c: 61: {
;LC-meter.c: 64: bres += 256;
	movlw	(0100h >> 8)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	addwf	(_bres+1),f	;volatile
	line	65
;LC-meter.c: 65: if(bres >= 5000)
	movlw	high(01388h)
...
i1l6970:	
;LC-meter.c: 71: }
;LC-meter.c: 73: T0IF = 0;
	bcf	(90/8),(90)&7
	line	93
	
i1l6972:	
;LC-meter.c: 74: }
;LC-meter.c: 93: if (RCIF) { rxfifo[rxiptr]=RCREG; ser_tmp=(rxiptr+1) & (16-1); if (ser_tmp!=rxoptr) rxiptr=ser_tmp; } if (TXIF && TXIE) { TXREG = txfifo[txoptr]; ++txoptr; txoptr &= (16-1); if (txoptr==txiptr) { TXIE = 0; } };
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(101/8),(101)&7
	goto	u57_21
