...
${OBJECTDIR}/_ext/807959592/main.p1: ../../../src/julznc/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 ../../../src/julznc/main.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\807959592" -DDEBUG=1 -D__DEBUG=1 -DUART_BAUD=38400 -D_XTAL_FREQ=20000000 -UNDEBUG -P -N127 -I"../../../src/julznc" -I"." -v --warn=5 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=default,+asm,-asmfile,-speed,+space,+debug,3 -D__DEBUG   --double=32 --float=24 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"
	@${MP_CC} --scandep  ../../../src/julznc/main.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\807959592" -DDEBUG=1 -D__DEBUG=1 -DUART_BAUD=38400 -D_XTAL_FREQ=20000000 -UNDEBUG -P -N127 -I"../../../src/julznc" -I"." -v --warn=5 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --opt=default,+asm,-asmfile,-speed,+space,+debug,3 -D__DEBUG   --double=32 --float=24 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"
...
${OBJECTDIR}/_ext/807959592/main.p1: ../../../src/julznc/main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/807959592" 
	${MP_CC} --pass1 ../../../src/julznc/main.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\807959592" -DDEBUG=1 -D__DEBUG=1 -DUART_BAUD=38400 -D_XTAL_FREQ=20000000 -UNDEBUG -P -N127 -I"../../../src/julznc" -I"." -v --warn=5 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=default,+asm,-asmfile,-speed,+space,+debug,3  --double=32 --float=24 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"
	@${MP_CC} --scandep  ../../../src/julznc/main.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\807959592" -DDEBUG=1 -D__DEBUG=1 -DUART_BAUD=38400 -D_XTAL_FREQ=20000000 -UNDEBUG -P -N127 -I"../../../src/julznc" -I"." -v --warn=5 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --opt=default,+asm,-asmfile,-speed,+space,+debug,3  --double=32 --float=24 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"
	@echo ${OBJECTDIR}/_ext/807959592/main.p1: > ${OBJECTDIR}/_ext/807959592/main.p1.d
	@cat ${OBJECTDIR}/_ext/807959592/main.dep >> ${OBJECTDIR}/_ext/807959592/main.p1.d
	@${FIXDEPS} "${OBJECTDIR}/_ext/807959592/main.p1.d" $(SILENT) -ht  -rsi ${MP_CC_DIR}../ 
