	...
	;
	; --chip=16F876A -G \
	; -mdist/release/production/LC_meter_16f876a_xc8.X.production.map \
	; -DXPRJ_release=release --double=32 --float=32 \
	; --opt=+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro \
	; -D__XC=1 -DUSE_TIMER0=1 -DUSE_TIMER1=1 -DUSE_TIMER2=1 -DUSE_UART=1 \
	; -DUSE_HD44780_LCD=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 \
	; -D__16f876a=1 -DNDEBUG=1 -P -N255 -I../../mplab -I. -I../../../src \
	; -I../../../lib -v --warn=-3 --asmlist \
	...
	; --summarydir=dist/release/production/memoryfile.xml \
	; -odist/release/production/LC_meter_16f876a_xc8.X.production.cof \
	; build/release/production/_ext/1386528437/print.p1 \
	; build/release/production/_ext/1386521430/ser.p1 \
	; build/release/production/_ext/1386521430/timer.p1 \
	; build/release/production/_ext/1386521430/format.p1 \
	; build/release/production/_ext/1386528437/LC-meter.p1 \
	; build/release/production/_ext/1386521430/lcd44780.p1 \
	; build/release/production/_ext/1386521430/buffer.p1 \
	; build/release/production/_ext/2037789166/measure.p1 \
	; build/release/production/_ext/1386521430/uart.p1
	;
