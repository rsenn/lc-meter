...
SOURCEFILES_QUOTED_IF_SPACED=../../../src/print.c ../../../lib/timer.c ../../../lib/format.c ../../../lib/buffer.c ../../../lib/lcd44780.c ../../../LC-meter.c ../../../lib/ser.c ../../../lib/uart.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1386528437/print.p1 ${OBJECTDIR}/_ext/1386521430/timer.p1 ${OBJECTDIR}/_ext/1386521430/format.p1 ${OBJECTDIR}/_ext/1386521430/buffer.p1 ${OBJECTDIR}/_ext/1386521430/lcd44780.p1 ${OBJECTDIR}/_ext/2124829536/LC-meter.p1 ${OBJECTDIR}/_ext/1386521430/ser.p1 ${OBJECTDIR}/_ext/1386521430/uart.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1386528437/print.p1.d ${OBJECTDIR}/_ext/1386521430/timer.p1.d ${OBJECTDIR}/_ext/1386521430/format.p1.d ${OBJECTDIR}/_ext/1386521430/buffer.p1.d ${OBJECTDIR}/_ext/1386521430/lcd44780.p1.d ${OBJECTDIR}/_ext/2124829536/LC-meter.p1.d ${OBJECTDIR}/_ext/1386521430/ser.p1.d ${OBJECTDIR}/_ext/1386521430/uart.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1386528437/print.p1 ${OBJECTDIR}/_ext/1386521430/timer.p1 ${OBJECTDIR}/_ext/1386521430/format.p1 ${OBJECTDIR}/_ext/1386521430/buffer.p1 ${OBJECTDIR}/_ext/1386521430/lcd44780.p1 ${OBJECTDIR}/_ext/2124829536/LC-meter.p1 ${OBJECTDIR}/_ext/1386521430/ser.p1 ${OBJECTDIR}/_ext/1386521430/uart.p1

# Source Files
SOURCEFILES=../../../src/print.c ../../../lib/timer.c ../../../lib/format.c ../../../lib/buffer.c ../../../lib/lcd44780.c ../../../LC-meter.c ../../../lib/ser.c ../../../lib/uart.c
...
${OBJECTDIR}/_ext/1386521430/timer.p1: ../../../lib/timer.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 ../../../lib/timer.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
	@${MP_CC} --scandep  ../../../lib/timer.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
...
${OBJECTDIR}/_ext/1386521430/format.p1: ../../../lib/format.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1386521430" 
	${MP_CC} --pass1 ../../../lib/format.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
...
${OBJECTDIR}/_ext/1386521430/buffer.p1: ../../../lib/buffer.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1386521430" 
	${MP_CC} --pass1 ../../../lib/buffer.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
	@${MP_CC} --scandep  ../../../lib/buffer.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
...
${OBJECTDIR}/_ext/2124829536/LC-meter.p1: ../../../LC-meter.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 ../../../LC-meter.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\2124829536" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
	@${MP_CC} --scandep  ../../../LC-meter.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\2124829536" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
...
${OBJECTDIR}/_ext/1386521430/ser.p1: ../../../lib/ser.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1386521430" 
	${MP_CC} --pass1 ../../../lib/ser.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
	@${MP_CC} --scandep  ../../../lib/ser.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
...
${OBJECTDIR}/_ext/1386521430/uart.p1: ../../../lib/uart.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1386521430" 
	${MP_CC} --pass1 ../../../lib/uart.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
	@${MP_CC} --scandep  ../../../lib/uart.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}\_ext\1386521430" -D__HTC=1 -DUSE_TIMER2=1 -DUSE_UART=1 -DXTAL_FREQ=20000000 -DBAUD_RATE=38400 -D__16f876a=1 -DUSE_TIMER0=1 -P -N255 -I"../../mplab" -I"." -I"../../../src" -I"../../../lib" --warn=1 --runtime=default,+clear,+init,-keep,-osccal,+oscval:0x3400,-resetbits,+download,+stackcall,+clib --opt=all,+asm,+asmfile,+speed,-space,-debug -D__DEBUG --debugger=pickit3  --double=32 --float=32 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --double=32
