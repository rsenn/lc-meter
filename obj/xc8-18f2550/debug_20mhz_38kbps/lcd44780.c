...
#include <stdarg.h>
#include <stdio.h>
#line 15 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
static uint8_t LCD_function, LCD_ctrl, LCD_mode
    ,
    LCD_lines
    ;
#line 33 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
static void
lcd_write4bits(uint8_t value) {
  #line 39 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
LATB &= 0b00001111;
  LATB |= value << 4;
  
  #line 55 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
LATB |= 0b1000; _delay((unsigned long)((4)*(20000000/4000000.0))); LATB &= ~0b1000; _delay((unsigned long)((100)*(20000000/4000000.0)));;
#line 60 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
}
#line 102 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_send(uint8_t value, uint8_t mode) {
  ...
  #line 115 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
{
    lcd_write4bits(value >> 4); 
    lcd_write4bits(value); 
  }
}
#line 126 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
static void
lcd_command(uint8_t value) {
  lcd_send(value, 0);
}
#line 134 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_gotoxy(uint8_t col, uint8_t row) {
  ...
  #line 146 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
if(LCD_lines == 1) {
    row_offsets[1] = 0x14;
    row_offsets[2] = 0x28;
    row_offsets[3] = 0x3C;
  ...
  #line 156 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
lcd_command(0x80 | (col + row_offsets[row]));
}
#line 162 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_puts(const char* string) {
  uint8_t i;
  for(i = 0; string[i]; i++) lcd_putch(string[i]);
}
#line 169 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_putch(char value) {
  lcd_send((unsigned char)value, 1);
}
#line 196 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
...
if(pad < 0) {
  ...
  #line 213 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
do {
    
    #line 217 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
di = n % base;
...
#line 280 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_home() {
  lcd_command(0x02);
...
#line 291 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_clear() {
  lcd_command(0x01); 
  _delay((unsigned long)((2)*(20000000/4000.0))); 
...
#line 311 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_display() {
  LCD_ctrl |= 0x04;
  lcd_command(0x08 | LCD_ctrl);
}
#line 321 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_no_cursor() {
  LCD_ctrl &= ~0x02;
  lcd_command(0x08 | LCD_ctrl);
}
#line 330 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_cursor() {
  LCD_ctrl |= 0x02;
  lcd_command(0x08 | LCD_ctrl);
}
#line 349 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_blink() {
  LCD_ctrl |= 0x01;
  lcd_command(0x08 | LCD_ctrl);
}
#line 376 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_left_to_right(void) {
  LCD_mode |= 0x02;
  lcd_command(0x04 | LCD_mode);
}
#line 396 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_autoscroll(void) {
  LCD_mode |= 0x01;
  lcd_command(0x04 | LCD_mode);
}
#line 415 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
lcd_begin(uint8_t lines, uint8_t dotsize) {
  if(lines > 1)
    LCD_function |= 0x08;
  #line 421 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
LCD_lines = lines;
   
  #line 425 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
...
#line 488 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
void
...
LCD_ctrl = 0;
  ...
  LCD_lines = 0;
  LCD_mode = 0;
  #line 498 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
TRISB &= ~0b0100;
  LATB &= ~0b0100;
  #line 504 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
TRISB &= ~0b1000;
  LATB &= ~0b1000;
  
LATB &= ~0b11110000;
#line 517 "/home/roman/Dokumente/Sources/lc-meter/obj/../lib/lcd44780.c"
}
