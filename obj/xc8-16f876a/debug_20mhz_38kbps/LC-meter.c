...
#line 7 "/home/roman/Sources/lc-meter/src/config-16f876a.h"
#pragma config FOSC = HS, LVP = OFF, CPD = OFF, BOREN = ON, WDTE = OFF, WRT = OFF, DEBUG = ON
#line 48 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
...
static char mode = -1;
#line 64 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
void
delay10ms(unsigned char period_10ms) {
  
#line 69 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
}
#line 73 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
...
#line 85 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
...
#line 111 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
}
#line 116 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
void
main() {
...
led_cycle = 0;
  ...
  #line 132 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
CMCON = 0b00000101;
  TRISA = 0b11001111;
  #line 136 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
TRISB &= 0b00001111;
...
timer0_init(0b1000 | 0x20 | 0x40);
  ...
  #line 149 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
OPTION_REG &= ~0b100000;
  
  
  #line 155 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
TRISC = 0b10110011;
  #line 159 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
RC3 = 1;
  #line 162 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
TRISC &= ~(1 << 2);
  PORTC &= ~(1 << 2); PORTC |= (!!(1)) << 2;;
  
timer2_init(0b000 | 0x80);
  
  #line 172 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
lcd_init(1);
  lcd_begin(2, 1);
  #line 176 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
TRISC |= (1 << 4);
  TRISC &= ~(1 << 5);
...
PORTC &= ~(1 << 5);
  ...
  delay10ms(50);
  PORTC &= ~(1 << 5);
  #line 190 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
ser_init();
  
  #line 197 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
INTCON |= 0xc0; 
  #line 203 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
lcd_gotoxy(0, 0);
  lcd_puts("LC-meter ");
  format_float(&lcd_putch, CCal);
  #line 210 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
delay10ms(5);
  #line 215 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
calibrate();
  #line 218 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
lcd_clear();
  
  #line 226 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
for(;;) {
...
ser_puts(mode ? "- C (Unit: F) -" : "- L (Unit: H) -");
    ...
    #line 237 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
...
INTCON &= ~0x80; 
  s = seconds;
  INTCON |= 0x80; 
  #line 274 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
lcd_gotoxy(10, 0);
  lcd_puts("      ");
  lcd_gotoxy(10, 0);
  format_number(&lcd_putch, s, 10, 5);
  #line 280 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
lcd_gotoxy(10, 1);
  lcd_puts("      ");
  lcd_gotoxy(10, 1);
...
lcd_gotoxy(0, 1);
  ...
  lcd_gotoxy(0, 1);
  lcd_puts("RC4=");
  #line 291 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
lcd_putch((!!(PORTC & (1 << 4))) != 0 ? '1' : '0');
  #line 295 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
if(s != prev_s) {
    
format_number(&ser_putch, s, 10, 0);
    
    ser_puts("\r\n");
    #line 302 "/home/roman/Sources/lc-meter/obj/../LC-meter.c"
prev_s = s;
  }
}
